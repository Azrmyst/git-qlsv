    ...
    <header>
       ...
       <div>
            ...
            <table>
                ...
                <tr>
                    <td colspan="6">
                    <button class="btn btn-info vt"> <a href="ThemKhoaHoc.php"> <i class="fas fa-user-plus"></i> Thêm Mới</a></button>
                    </td>
                </tr>
                <tr class= "tieude">
                    <th>STT</th>
            ...
            <tr>
                    ...
                    <td><?= $row["NamKT"] ?></td>
                    <td>
                        <button class="btn btn-danger" type="submit" name='btnXoa' value='<?= $row["MaKH"] ?>'>Xóa</button>
                        <button class="btn btn-success"> <a href="SuaKhoaHoc.php?id=<?=$row["MaKH"]?>">Sửa</a></button>
