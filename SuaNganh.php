       ...
       <div>
        ...
        <table>
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <tr>
                        <td style= padding:13px>Mã Ngành</td>
                        <td style=text-align:center><input type="text" value="<?= $row['MaNganh']?>"></td>
                    </tr>
                    <tr>
                        <td style= padding:13px>Tên Ngành</td>
                        <td style=text-align:center><input type="text" name="TenNganh"  value="<?= $row['TenNganh']?>"></td>
                    </tr>
                    <tr>
                        <td style=padding:13px><input type="submit" value="Sửa" class="btn btn-success"></td>
                        <td><button class="btn btn-info"> <a href="QLNganh.php">Danh Sách</a></button></td>
                    </tr>
            </form>
        </table>
            <?php
            ...
            $sql = "UPDATE Nganh set  TenNganh = '$TenNganh' where MaNganh = '$id'";
            if($TenNganh != '' )
            {
                ...
                if ($a > 0) 
                        {  
                            ...
                            window.location = "http://localhost:8080/Mountain/BTLon/SuaNganh.php?id='.$id.'"
                            </script>';     
                        } 
                else
                        {
