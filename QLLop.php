    ...
    <header>
       ...
       <div>
            ...
            <table>
                ...
                <tr>
                    <td colspan="6">
                    <button class="btn btn-info vt"> <a href="ThemLop.php"><i class="fas fa-user-plus"></i> Thêm Mới</a></button>
                    </td>
                </tr>
                <tr class= "tieude">
                    <th>STT</th>
            ...
            <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-danger" type="submit" name='btnXoa' value='<?= $row["MaLop"] ?>'>Xóa</button>
                        <button class="btn btn-success"> <a href="SuaLop.php?id=<?=$row["MaLop"]?>">Sửa</a></button>
                    </td>
            </tr>
            <?php
                $i++;
