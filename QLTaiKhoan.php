    ...
    <header>
       ...
       <div>
            ...
            <table>
                ...
                <tr>
                    <td colspan="6">
                    <button class="btn btn-info vt"> <a href="ThemTaiKhoan.php"><i class="fas fa-user-plus"></i> Thêm Mới</a></button>
                    </td>
                </tr>
                <tr class= "tieude">
                    <th>STT</th>
            ...
            <tr>
                    ...
                    <td><?= $row["TenTK"] ?></td>
                    <td>
                        <button class="btn btn-danger" type="submit" name='btnXoa' value='<?= $row["TenTK"] ?>'>Xóa</button>
                        <button class="btn btn-success"> <a href="SuaTaiKhoan.php?id=<?=$row["TenTK"]?>">Sửa</a></button>
