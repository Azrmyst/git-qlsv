...
if (isset($_POST["btnThem"]))
{
    ...
    include 'ketnoi.php';
    $sql_insert = "insert into Nganh values('".$MaNganh."','".$TenNganh."')";
    if($MaNganh != '' && $TenNganh!=''){
        mysqli_query($conn,$sql_insert);
        echo'<script type="text/javascript">alert("Thêm Thành công!!");</script>';

    }else{
        echo'<script type="text/javascript">alert("Bạn phải nhập Mã Ngành và Tên Ngành");</script>';
    }
}
?>
<body class="body1">
       ...
       <div>
        ...
        <form action="#" method="post">
            <table>
                ...
                <tr>
                    <td>Mã Ngành</td>
                    <td><input type="text" name="MaNganh"></td>
                </tr>
                <tr>
                    <td>Tên Ngành</td>
                    <td><input type="text" name="TenNganh"></td>
                </tr>
                <tr>
