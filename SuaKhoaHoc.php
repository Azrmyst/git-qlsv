       ...
       <div>
        ...
        <table>
            <?php
                ...
                $sql = "SELECT * FROM KhoaHoc where MaKH = '".$id."'";
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <tr>
                        <td style= padding:13px>Mã Khóa Học</td>
                        <td style=text-align:center><input type="text" value="<?= $row['MaKH']?>"></td>
                    </tr>
                    <tr>
                        <td style= padding:13px>Năm Bắt Đầu</td>
                        <td style=text-align:center><input type="text" name="NamBD"  value="<?= $row['NamBD']?>"></td>
                    </tr>
                    <tr>
                        <td style= padding:13px>Năm Kết Thúc</td>
                        <td style=text-align:center><input type="text" name="NamKT"  value="<?= $row['NamKT']?>"></td>
                    </tr>
                    <tr>
            ...
            $sql = "UPDATE KhoaHoc set  NamBD = '$NamBD', NamKT = '$NamKT' where MaKH = '$id'";
            if($NamBD != '' && $NamKT != '' )
            {
                ...
                if ($a > 0) 
                        {  
                            ...
                            window.location = "http://localhost:8080/Mountain/BTLon/SuaKhoaHoc.php?id='.$id.'"
                            </script>';     
                        } 
                else
                        {
